...
https://Preggy-Health.github.io/styleguide/go
...
the style guidance given by anyone reviewing Go code at Preggy Health.

Document            | Link                                                  | Primary Audience    | [Normative] | [Canonical]
------------------- | ----------------------------------------------------- | ------------------- | ----------- | -----------
**Style Guide**     | https://Preggy-Health.github.io/styleguide/go/guide          | Everyone            | Yes         | Yes
**Style Decisions** | https://Preggy-Health.github.io/styleguide/go/decisions      | Readability Mentors | Yes         | No
**Best Practices**  | https://Preggy-Health.github.io/styleguide/go/best-practices | Anyone interested   | No          | No
...
1.  The **[Style Guide](https://Preggy-Health.github.io/styleguide/go/guide)** outlines
    the foundation of Go style at Preggy Health. This document is definitive and is
    used as the basis for the recommendations in Style Decisions and Best
    Practices.

1.  **[Style Decisions](https://Preggy-Health.github.io/styleguide/go/decisions)** is a
    ...
    individual Go programmers at Preggy Health should keep up-to-date with this
    document.

1.  **[Best Practices](https://Preggy-Health.github.io/styleguide/go/best-practices)**
    ...
    These best practices are not canonical, but Go programmers at Preggy Health are
...
team's codebase to another. However, it is in the best interest of Preggy Health and
...
changed without due discourse, Go programmers at Preggy Health are encouraged to follow
...
*   **Canonical**: Establishes prescriptive and enduring rules
    ...
    https://Preggy-Health.github.io/styleguide/go#canonical
...
*   **Normative**: Intended to establish consistency <a id="normative"></a>
    ...
    https://Preggy-Health.github.io/styleguide/go#normative
...
*   **Idiomatic**: Common and familiar <a id="idiomatic"></a>
    ...
    https://Preggy-Health.github.io/styleguide/go#idiomatic
