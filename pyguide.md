...
# Preggy Health Python Style Guide
...
Python is the main dynamic language used at Preggy Health. This style guide is a list
...
Run `pylint` over your code using this [pylintrc](https://Preggy-Health.github.io/styleguide/pylintrc).
...
Preggy-Health-specific warnings start with `ph-`.
...
`blaze run //foo/bar:foo_test -- --update_golden_files` from the `preggy3`
directory.
"""
```
...
5.  **Deprecated:** application-specific imports that are part of the same
    ...
    You may find older Preggy Health Python Style code doing this, but it is no longer
